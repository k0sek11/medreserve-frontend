...
const AppointmentConfirmationPage = () => {
  ...
  return (
    <Paper elevation={0} sx={{ p: { xs: 2.5, md: 4 }, borderRadius: 3, border: "1px solid #dce5f2" }}>
      <Stack spacing={2.5}>
        <Box>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1.2}>
          <Button component={RouterLink} to="/moje-wizyty" variant="contained" sx={{ textTransform: "none", fontWeight: 700 }}>
            Przejdź do moich wizyt
          </Button>
          <Button component={RouterLink} to="/lekarze" variant="outlined" sx={{ textTransform: "none" }}>
            Umów kolejną wizytę
          </Button>
        </Stack>
      </Stack>
